...
const translations: Record<Locale, Record<string, string>> = {
  vi: {
    ...
    "customer.shopee": "Giao Shopee",
    "customer.grab": "Giao Grab",
    "customer.grabFeeNote": "Phí Grab sẽ được tính riêng theo khoảng cách",
    "customer.grabPendingFee": "Grab - chờ tính phí",
    ...
    "customer.notes": "Ghi chú giao hàng",
    "customer.notesPlaceholder": "VD: Giao giờ hành chính, gọi trước khi giao, để ở lễ tân...",
    "customer.continue": "Tiếp tục đặt hàng",
  ...
  en: {
    ...
    "customer.shopee": "Shopee Express",
    "customer.grab": "Grab Delivery",
    "customer.grabFeeNote": "Grab fee will be calculated based on distance",
    "customer.grabPendingFee": "Grab - pending fee",
    ...
    "customer.notesPlaceholder": "e.g. Deliver during office hours, call before delivery, leave at reception...",
    "customer.continue": "Continue to order",
