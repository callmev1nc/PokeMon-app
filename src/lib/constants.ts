...
export const POKEMON_TYPE_ENERGY_ICONS: Record<string, string> = {
  ...
  Flying: "/energy/colorless.png",
  Poison: "/energy/psychic.png",
  Ground: "/energy/fighting.png",
  Rock: "/energy/fighting.png",
  Bug: "/energy/grass.png",
  Ghost: "/energy/psychic.png",
  Dragon: "/energy/dragon.png",
  Metal: "/energy/metal.png",
  Ice: "/energy/water.png",
