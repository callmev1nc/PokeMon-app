...
export default function CustomerInfoPage() {
  ...
  const [deliveryMethod, setDeliveryMethod] = useState<"shopee" | "grab" | "pickup">("shopee");
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if ((deliveryMethod === "shopee" || deliveryMethod === "grab") && !oldAddress.trim()) errs.oldAddress = t("customer.oldAddressError", locale);
    setFieldErrors(errs);
    setTouched({ name: true, phone: true, oldAddress: deliveryMethod !== "pickup" });
        ...
        <form onSubmit={handleSubmit} className="vault-card p-5 md:p-6 space-y-5">
          ...
          <div>
            ...
            <div className="grid grid-cols-3 gap-2">
              <button
                type="button"
                onClick={() => setDeliveryMethod("shopee")}
              ...
              >
                ...
                <span className="text-xs">{t("customer.shopee", locale)}</span>
              ...
              >
                ...
                <span className="text-xs">{t("customer.grab", locale)}</span>
                <span className="text-[10px] font-normal opacity-70">Phí theo km</span>
              </button>
              <button
                type="button"
              ...
              >
                ...
                <span className="text-xs">{t("customer.pickup", locale)}</span>
