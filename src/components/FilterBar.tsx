    ...
    <div className="flex flex-col gap-3 mb-6 sticky top-16 z-20 py-3 -mx-4 px-4 bg-surface-alt/90 backdrop-blur-md">
      ...
      <div className="relative group">
        <svg
          ...
          strokeWidth={2}
          stroke="currentColor"
          className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-600 group-focus-within:text-brand-yellow transition-colors"
        >
        ...
        <input
          ...
          className="w-full pl-10 pr-4 py-2.5 bg-slate-800/30 border border-slate-700/50 rounded-xl text-sm text-slate-200 placeholder:text-slate-600 focus:border-brand-yellow transition-all"
        />
        {search && (
          <button
            onClick={() => onSearchChange("")}
            className="absolute right-3 top-1/2 -translate-y-1/2 p-0.5 rounded-full bg-slate-800/50 text-slate-500 hover:text-slate-300 hover:bg-slate-700/50 transition-colors"
          >
            ...
            <button
              ...
              className={`btn-press px-3 py-1.5 rounded-lg text-xs font-bold transition-all duration-200 ${
                isActive
                  ...
                  : "bg-[#0F1629] text-slate-400 border border-slate-700/50 hover:border-slate-600 hover:text-slate-300"
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <div className="flex items-center gap-2 ml-auto">
          <select
            ...
            className="px-3 py-1.5 bg-slate-800/30 border border-slate-700/50 rounded-lg text-xs text-slate-300 cursor-pointer"
          >
