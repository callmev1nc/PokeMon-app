    ...
    <header className="sticky top-0 z-40 glass">
      <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-1">
          ...
          <a
            href="/order-tracking"
            className="hidden sm:inline-flex items-center gap-1.5 text-sm text-slate-500 hover:text-amber-400 transition-colors px-3 py-2 rounded-xl hover:bg-amber-500/10"
          >
          ...
          <button
            ...
            aria-label="Wishlist"
          >
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className={`w-5 h-5 transition-colors ${wishIds.length > 0 ? "fill-red-500 text-red-500" : "fill-none text-slate-500"}`} strokeWidth={2} stroke="currentColor">
          ...
          >
            ...
            {cartCount > 0 && (
              <span className="absolute -top-0.5 -right-0.5 bg-amber-500 text-black text-[10px] font-bold rounded-full w-5 h-5 flex items-center justify-center shadow-sm animate-fade-in">
