...
export default function Header({
  ...
  return (
    <header className="sticky top-0 z-40 bg-white/95 backdrop-blur-md border-b-2 border-brand-yellow/30 shadow-sm">
      <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <a
            href="/order-tracking"
            className="inline-flex items-center gap-1.5 text-sm text-slate-500 hover:text-accent transition-colors px-3 py-1.5 rounded-lg hover:bg-brand-yellow/10"
          >
          ...
          <a
            href="/admin"
            className="inline-flex items-center gap-1.5 text-sm text-slate-500 hover:text-brand transition-colors px-3 py-1.5 rounded-lg hover:bg-brand-yellow/10"
          >
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4">
