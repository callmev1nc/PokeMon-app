  ...
  return (
    <nav className="mobile-nav sm:hidden">
      <div className="flex items-center justify-around h-14">
        <a
          href="/"
          className="flex flex-col items-center gap-0.5 text-slate-400 dark:text-slate-500 hover:text-[#E53E3E] transition-colors py-1 px-3 min-w-[56px]"
        >
        ...
        <button
          onClick={onCartClick}
          className="relative flex flex-col items-center gap-0.5 text-slate-400 dark:text-slate-500 hover:text-[#E53E3E] transition-colors py-1 px-3 min-w-[56px]"
        >
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
