    ...
    <nav className="mobile-nav sm:hidden">
      <div className="flex items-center justify-around h-14">
        ...
        >
          ...
          {cartCount > 0 && (
            <span key={cartCount} className="absolute top-0 right-1 bg-amber-500 text-black text-[8px] font-bold rounded-full w-4 h-4 flex items-center justify-center animate-badge-pop">
